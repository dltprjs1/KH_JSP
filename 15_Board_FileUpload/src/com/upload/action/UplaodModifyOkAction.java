...
public class UplaodModifyOkAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		int upload_no = Integer.parseInt(mr.getParameter("upload_no").trim());
		String db_pwd = mr.getParameter("db_pwd").trim();
		...
		int res = dao.updateUpload(dto,db_pwd);
